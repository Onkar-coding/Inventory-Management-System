...
def buyItem():
    ...
    inventoryFile = open("stock.json", "r")
    ...
    while(True):
        ...
        if(buyChoice == 1):
            ...
            #Updating Inventory
            inventoryFile = open("stock.json", "w")
    ...
    print("*"*55)
    print(("*"*20)+"SuperMart"+("*"*21))
    print(("*"*17)+"visit superstore.com !"+("*"*17))
    ...
    print("*"*55)
    print("******Thank You For Purchasing At SuperMart*******")
